    ...
    function _kopRaporHTMLPrint() {
        ...
        <div style="background:#fff;padding:12px 20px 8px;border-bottom:4px double #003087;">
            <div style="display:flex;align-items:center;gap:14px;">
                <div style="flex-shrink:0;">${logoEl}</div>
                <div style="text-align:center;flex:1;">
                    <div style="font-size:0.62rem;font-weight:700;letter-spacing:2px;color:#333;text-transform:uppercase;line-height:1.7;">PEMERINTAH PROVINSI JAWA TENGAH</div>
...
<div style="padding:0 24px 8px;">
  ...
  <div style="margin-top:8px;font-size:0.72rem;color:#555;">${s.kota||'______'}, ${tanggal}</div>
</div>
<!-- TANDA TANGAN -->
<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;padding:8px 24px 16px;border-top:1px solid #dde;font-size:0.78rem;text-align:center;">
  <div>
    <div style="font-size:0.65rem;color:#777;margin-bottom:2px;">Orang Tua / Wali Murid,</div>
    <div style="height:55px;"></div>
    <div style="border-bottom:1px solid #333;margin:0 16px;"></div>
    <div style="font-size:0.7rem;color:#555;margin-top:3px;">(_______________________)</div>
  </div>
  <div>
    <div style="font-size:0.65rem;color:#777;margin-bottom:2px;">Wali Kelas,</div>
    <div style="height:55px;"></div>
    <div style="border-bottom:1px solid #333;margin:0 16px;"></div>
    <div style="font-weight:700;font-size:0.78rem;margin-top:3px;color:#222;">${wali}</div>
  </div>
  <div style="text-align:right;">
    <div style="font-size:0.65rem;color:#777;text-align:right;">Kepala Sekolah,</div>
    <div style="height:42px;"></div>
    <div style="border-bottom:1px solid #333;margin:0 0;"></div>
    <div style="font-weight:700;font-size:0.78rem;margin-top:3px;color:#222;text-align:right;">${s.kepsek||'—'}</div>
    ${s.nipKepsek?`<div style="font-size:0.62rem;color:#666;text-align:right;">NIP. ${s.nipKepsek}</div>`:''}
  </div>
</div>
</div><!-- /rapor-wrapper -->
</div><!-- /rapor-page -->`;
